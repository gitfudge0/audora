    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new LibraryViewModel(singletonCImpl.settingsRepositoryProvider.get(), singletonCImpl.trackDao(), viewModelCImpl.mediaScanner(), singletonCImpl.lrclibRepositoryProvider.get(), singletonCImpl.lrcWriterProvider.get(), singletonCImpl.tagWriterProvider.get());
          ...
          return (T) new TrackDetailViewModel(viewModelCImpl.savedStateHandle, singletonCImpl.trackDao(), singletonCImpl.tagWriterProvider.get(), singletonCImpl.lrclibRepositoryProvider.get(), singletonCImpl.lrcWriterProvider.get(), singletonCImpl.settingsRepositoryProvider.get());
