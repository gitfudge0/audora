...
private fun MetricsLightPreview() = AudoraTheme(themeMode = ThemeMode.Light) { MetricsPreviewContent() }

@Preview(name = "Metrics · Dark") @Composable
private fun MetricsDarkPreview() = AudoraTheme(themeMode = ThemeMode.Dark) { MetricsPreviewContent() }
