package dev.gitfudge.audora.ui.theme
...
/**
 * Audora palette — bone-and-ink with a single sodium-lamp accent.
 * Source of truth is the handoff design system (audora-tokens.css). Chrome is pure
...
internal val LightPalette = Palette(
    background = Color(0xFFFFFFFF),       // audora-paper
    surface = Color(0xFFFAFAFA),          // audora-bone
    surfaceVariant = Color(0xFFF4F4F4),   // audora-paper-2
    surfaceElevated = Color(0xFFFAFAFA),  // audora-bone
    pressed = Color(0xFFEBEBEB),          // audora-paper-3
    outline = Color(0xFFE8E8E8),          // audora-line
    outlineSubtle = Color(0xFFE8E8E8),    // audora-line
    outlineStrong = Color(0xFFC0C0C0),    // audora-fog
    onSurface = Color(0xFF111111),        // audora-ink
    onSurfaceVariant = Color(0xFF4A4A4A), // audora-graphite
    onSurfaceFaint = Color(0xFF888888),   // audora-stone
    disabled = Color(0xFFC0C0C0),         // audora-fog
    accent = Color(0xFF111111),           // audora-ink
    accentContainer = Color(0xFFFBE6D9),  // audora-sodium-wash
    onAccent = Color(0xFFFFFFFF),         // audora-paper
    onAccentContainer = Color(0xFFB9461A),// audora-sodium-deep
    sodium = Color(0xFFDF5A24),           // audora-sodium
    sodiumDeep = Color(0xFFB9461A),       // audora-sodium-deep
    sodiumWash = Color(0xFFFBE6D9),       // audora-sodium-wash
    sodiumLine = Color(0xFFF2B997),       // audora-sodium-line
...
internal val DarkPalette = Palette(
    background = Color(0xFF000000),       // audora-graphite-bg (true black)
    surface = Color(0xFF111111),          // audora-graphite-2
    surfaceVariant = Color(0xFF1A1A1A),   // audora-graphite-3
    surfaceElevated = Color(0xFF111111),  // audora-graphite-2
    ...
    onAccent = Color(0xFF111111),         // audora-ink
    onAccentContainer = Color(0xFFDF5A24),// sodium reads on dark wash
    sodium = Color(0xFFDF5A24),           // audora-sodium (unchanged in dark)
