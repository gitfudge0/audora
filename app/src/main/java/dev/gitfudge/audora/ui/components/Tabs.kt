...
private fun TabsLightPreview() = AudoraTheme(themeMode = ThemeMode.Light) { TabsPreviewContent() }

@Preview(name = "Tabs · Dark") @Composable
private fun TabsDarkPreview() = AudoraTheme(themeMode = ThemeMode.Dark) { TabsPreviewContent() }
