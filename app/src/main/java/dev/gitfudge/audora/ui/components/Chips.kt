...
private fun ChipsLightPreview() = AudoraTheme(themeMode = ThemeMode.Light) { ChipsPreviewContent() }

@Preview(name = "Chips · Dark") @Composable
private fun ChipsDarkPreview() = AudoraTheme(themeMode = ThemeMode.Dark) { ChipsPreviewContent() }
