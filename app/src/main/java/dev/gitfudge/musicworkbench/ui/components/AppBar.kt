...
private fun AppBarLightPreview() = MusicWorkbenchTheme(themeMode = ThemeMode.Light) { AppBarPreviewContent() }

@Preview(name = "AppBar · Dark") @Composable
private fun AppBarDarkPreview() = MusicWorkbenchTheme(themeMode = ThemeMode.Dark) { AppBarPreviewContent() }
