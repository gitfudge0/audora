...
private fun SectionLightPreview() = MusicWorkbenchTheme(themeMode = ThemeMode.Light) { SectionPreviewContent() }

@Preview(name = "Section · Dark") @Composable
private fun SectionDarkPreview() = MusicWorkbenchTheme(themeMode = ThemeMode.Dark) { SectionPreviewContent() }
